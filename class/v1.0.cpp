...
int main()
{
	...
	auto laikas4 = duration<double>::zero();
	auto laikas5 = duration<double>::zero();
	int dydis = 0;
	MyVector<mokiniai> M(1000000);
	MyVector<mokiniai> B(1000000);
	...
	laikas4 = duration_cast<duration<double>>(pabaiga4 - pradzia4);
	...
	laikas5 = duration_cast<duration<double>>(pabaiga5 - pradzia5);

	cout << "Testai su " << sz << " elementu:\n\n";
	cout << "std::vector laikas: " << fixed << setprecision(5) << laikas4.count() << endl;
	cout << "MyVector laikas: " << fixed << setprecision(5) << laikas5.count() << endl;
	cout << "Testas baigesi.\n\n";
