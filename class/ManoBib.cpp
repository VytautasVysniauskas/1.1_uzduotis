...
void spauzdinimasFaile(MyVector<mokiniai>& M, MyVector<mokiniai>& B, int dydis, duration<double>& laikas3)
{
	char raide;
...
void spauzdinimasEkrane(MyVector<mokiniai>& M, int dydis)
{
	char raide;
...
void vidurys(MyVector<mokiniai>& M, int dydis)
{
	for (int i = 0; i < dydis; i++)
	{
...
int skaitymasRanka(MyVector<mokiniai>& M, int dydis)
{
	string vardas, pav;
	double sk, test;
	int i = 0;
...
void rikiavimas(MyVector<mokiniai>& M, int dydis, char pasirinkimas)
{
...
int skaitymasFailo(MyVector<mokiniai>& M, int dydis, duration<double>& laikas1)
{
	string fileV;
